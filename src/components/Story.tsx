    ...
    <Page id="story" isDarkMode={isDarkMode}>
      ...
      <Content>
        ...
        <About>
          ...
          <p>From struggling to figure out how to position a div in a flexbox to hitting wall after wall trying to code for the first time using React hooks and TypeScript together, I fell in love with the process of researching and problem solving in coding.</p>
